      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-20">
          ...
          <div className="flex flex-col items-start text-left gap-6">
            ...
            <ul className="flex flex-col gap-5 items-start">
              ...
              <li>
                <a href="mailto:info@estics.it" className="flex items-start gap-3 group">
                  <Mail size={18} className="text-[#a67c52] shrink-0" />
                  <div className="flex flex-col">
                    <span className="text-black font-medium text-sm">info@estics.it</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="flex flex-col items-center md:items-start">
                  <span className="text-black font-medium text-sm">Via Dante Alighieri, 27</span>
                  <span className="text-stone-400 text-xs">25014 Castenedolo (BS), Italia</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-12 border-t border-stone-200/60 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-stone-400 text-[11px] tracking-wide uppercase">
            &copy; {currentYear} Estics Centro Estetico — Tutti i diritti riservati
          </p>
