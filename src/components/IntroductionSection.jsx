...
const IntroductionSection = () => {
        ...
        gsap.fromTo(img, 
          ...
          },
          {
            ...
            scrollTrigger: {
              ...
              scrub: 1, // Faster scrub for a more locked feeling
            }
          }
        );
      });
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative lg:min-h-screen w-full flex flex-col items-center justify-start lg:justify-center overflow-hidden pt-4 lg:pt-0 pb-20 lg:pb-0 bg-[#faf9f6]"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-16 flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-[10px] md:text-xs font-bold tracking-[0.2em] text-[#a67c52] uppercase">
            Bellezza e benessere per ogni tipo di pelle
          </span>
        </div>
